...
public class SudokuController extends AbstractController {
    ...
    public void initialize() {
        ...
        final File xmlFile = new File(this.getClass().getClassLoader().getResource("jsudoku.xml").getFile());
        JsudokuType jsudoku = (JsudokuType) JAXBUtil.unmarshal(xmlFile, JsudokuType.class);
